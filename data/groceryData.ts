...
export const GROCERY_SUB_CATEGORIES: GrocerySubCategory[] = [
  { key: "vegetables",  label: "Vegetables",         icon: "leaf-outline",          bg: "#DCFCE7" },
  { key: "fruits",      label: "Fruits",              icon: "nutrition-outline",     bg: "#FEF3C7" },
  { key: "dairy",       label: "Milky Products",      icon: "water-outline",         bg: "#DBEAFE" },
  { key: "dryfruits",   label: "Dry Fruits",          icon: "ellipse-outline",       bg: "#FFEDD5" },
  { key: "pulses",      label: "Wheat, Dal & Pulses", icon: "layers-outline",        bg: "#FEE2E2" },
...
export const REGULAR_ITEMS: GroceryProduct[] = [
  { id:"r1",  name:"Potatoes",    price:"₹20–45/kg",        icon:"earth-outline",        bg:"#FEF3C7", badge:"Fresh"   },
  { id:"r2",  name:"Tomato",      price:"₹25–45/kg",        icon:"radio-button-on",      bg:"#FEE2E2", badge:"Fresh"   },
  { id:"r3",  name:"Onion",       price:"₹15–40/kg",        icon:"ellipse-outline",      bg:"#FCE7F3"                  },
  { id:"r4",  name:"Cow Milk",    price:"₹50–70/litre",     icon:"water-outline",        bg:"#DBEAFE", badge:"Daily"   },
  { id:"r5",  name:"Buffalo Milk",price:"₹60–80/litre",     icon:"water-outline",        bg:"#E0F2FE"                  },
  ...
  { id:"r9",  name:"Wheat Flour", price:"₹45–90/kg",        icon:"layers-outline",       bg:"#FEF3C7"                  },
...
export const SEASONAL_ITEMS: GroceryProduct[] = [
  { id:"s1",  name:"Mango",       price:"₹200–450/kg",      icon:"nutrition-outline",    bg:"#FEF3C7", badge:"Season"  },
  { id:"s2",  name:"Kothimbir",   price:"₹10–30/kg",        icon:"leaf-outline",         bg:"#DCFCE7", badge:"Fresh"   },
  { id:"s3",  name:"Lemons",      price:"₹15–40/kg",        icon:"radio-button-on",      bg:"#FEFCE8"                  },
