...
export const FASHION_GENDERS: FashionGenderConfig[] = [
  // ── MEN ────────────────────────────────────────────────────
  {
    ...
    subCats: [
      ...
      { key: "bottomwear",  label: "Bottom-wear",  icon: "reorder-three-outline",    bg: "#DCFCE7", imageUrl: require("../assets/images/fashion/bottom_wear.png") },
      ...
      { key: "watches",     label: "Watches",      icon: "time-outline",             bg: "#FFEDD5", imageUrl: require("../assets/images/fashion/watches.png") },
      ...
      { key: "kurti",       label: "Kurti",        icon: "shirt-outline",            bg: "#FCE7F3", imageUrl: require("../assets/images/fashion/kurti.png") },
  ...
  // ── WOMEN ──────────────────────────────────────────────────
  {
    ...
    subCats: [
      ...
      { key: "kurties",     label: "Kurties",      icon: "shirt-outline",            bg: "#FCE7F3", imageUrl: require("../assets/images/fashion/kurti.png") },
