...
export const FASHION_GENDERS: FashionGenderConfig[] = [
  // ── MEN ────────────────────────────────────────────────────
  {
    ...
    icon:  "man-outline",
    subCats: [
      { key: "topwear",     label: "Topwear",      icon: "shirt-outline",            bg: "#DBEAFE", imageUrl: require("../assets/images/category/products/mens.png") },
      ...
      { key: "bottomwear",  label: "Bottom-wear",  icon: "reorder-three-outline",    bg: "#DCFCE7", imageUrl: require("../assets/images/category/products/mens.png") },
      ...
      { key: "wallets",     label: "Wallets",      icon: "wallet-outline",           bg: "#F3F4F6", imageUrl: require("../assets/images/category/products/accessories.png") },
      ...
      { key: "blazers",     label: "Blazer",       icon: "business-outline",         bg: "#DBEAFE", imageUrl: require("../assets/images/category/products/mens.png") },
  ...
  // ── WOMEN ──────────────────────────────────────────────────
  {
    ...
    icon:  "woman-outline",
    subCats: [
      { key: "topwear",     label: "Topwear",      icon: "shirt-outline",            bg: "#FCE7F3", imageUrl: require("../assets/images/category/products/fashion.png") },
      { key: "innerwear",   label: "Inner-wear",   icon: "body-outline",             bg: "#FEE2E2", imageUrl: require("../assets/images/category/products/innerwear.png") },
      { key: "bottomwear",  label: "Bottom-wear",  icon: "reorder-three-outline",    bg: "#DCFCE7", imageUrl: require("../assets/images/category/products/fashion.png") },
      { key: "footwear",    label: "Footwear",     icon: "walk-outline",             bg: "#FEF3C7", imageUrl: require("../assets/images/category/products/footwear.png") },
      { key: "sarees",      label: "Sarees",       icon: "sparkles-outline",         bg: "#FCE7F3", imageUrl: require("../assets/images/category/products/ethnic.png") },
      { key: "suits",       label: "Suits",        icon: "ribbon-outline",           bg: "#EDE9FE", imageUrl: require("../assets/images/category/products/ethnic.png") },
      { key: "watches",     label: "Watches",      icon: "time-outline",             bg: "#FFEDD5", imageUrl: require("../assets/images/category/products/smartwatch.png") },
