...
export const FASHION_GENDERS: FashionGenderConfig[] = [
  ...
  // ── BOY (Kids) ─────────────────────────────────────────────
  {
    ...
    subCats: [
      ...
      { key: "socks",       label: "Socks",        icon: "footsteps-outline",        bg: "#ECFDF5" },
      { key: "jackets",     label: "Jackets",      icon: "layers-outline",           bg: "#F3F4F6", imageUrl: require("../assets/images/fashion/boy_winterwear.png") },
  ...
  // ── GIRL (Kids) ────────────────────────────────────────────
  {
    ...
    subCats: [
      ...
      { key: "jackets",     label: "Jackets",      icon: "layers-outline",           bg: "#F3F4F6", imageUrl: require("../assets/images/fashion/girl_winterwear.png") },
