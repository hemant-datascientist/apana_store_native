...
const SUB_CATS: SubCat[] = [
  ...
  { key: "haircare",   label: "Hair Care",        icon: "cut-outline",             bg: "#EDE9FE", apc: "APC-04-PCARE", imageUrl: require("../../../../assets/images/category/products/home_haircare.webp") },
  ...
  { key: "grooming",   label: "Grooming",         icon: "person-outline",          bg: "#DBEAFE", apc: "APC-04-PCARE", imageUrl: require("../../../../assets/images/category/products/home_grooming.webp") },
  ...
  { key: "bodycare",   label: "Body Care",        icon: "body-outline",            bg: "#FFEDD5", apc: "APC-04-PCARE", imageUrl: require("../../../../assets/images/category/products/home_bodycare2.webp") },
];
